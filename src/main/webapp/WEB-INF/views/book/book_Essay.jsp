...
<div id="sub_Content_Essay">
	<!--  SLIDER CLASS NAME 변경  -->
	<div class="best_slider_Essay"></div>
	<div class="main_Time_Essay">
	...
	<div class="main_Recom_Essay">
		<div class="main_Recom">
			<div class="main_Recom_Inner">
				<h4>오늘의 에세이 추천</h4>
				<div class="Essay_RecomBook_Slide"></div>
			</div>
		</div>
	</div>
...
<script defer>
	$(".headerCategory li:nth-child(4) a").addClass("on");
</script>
